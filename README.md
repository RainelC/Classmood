...
Si desea probar la función de pasar lista y reconocer las emociones de los estudiantes diríjase al script.js y en la función ``` mostrarCamara() ```  comentar la línea 23 y descomentar la línea 24.
